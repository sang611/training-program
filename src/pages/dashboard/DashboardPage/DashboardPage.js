...
import CreateInstitutionPage from '../../institution/CreateInstitutionPage'
...
import CreateTrainingProgramPage from "../../training_program/CreateTrainingProgramPage";
...
import UpdateTrainingProgramPage from "../../training_program/UpdateTrainingProgramPage";
import LearningOutcomePage from "../../learning_outcome/LearningOutcomePage/LearningOutcomePage";
import LearningOutcomeTitlePage from "../../learning_outcome/LearningOutcomeTitlePage/LearningOutcomePageTitle";
...
import AdminStatisticPage from "../../statistic/AdminStatisticPage";
import ScrollToTop from "../../../ScrollToTop";
import TrainingProgramType from "../../training_program_type";
import CourseClass from "../../course_class";
import CourseYear from "../../course_year";
            ...
            <Layout style={{minHeight: '100vh'}}>
                ...
                >
                    ...
                    >
                        ...
                        <SubMenu key="sub5" icon={<PartitionOutlined />} title="Thông tin khác" className="sub-menu">
                            <Menu.Item key="/uet/majors" className="menu-item-child">
                                <Link to="/uet/majors">Ngành đào tạo</Link>
                            </Menu.Item>
                            <Menu.Item key="/uet/training-types" className="menu-item-child">
                                <Link to="/uet/training-types">Hệ đào tạo</Link>
                            </Menu.Item>
                            <Menu.Item key="/uet/course-year" className="menu-item-child">
                                <Link to="/uet/course-year">Khóa học</Link>
                            </Menu.Item>
                            <Menu.Item key="/uet/course-class" className="menu-item-child">
                                <Link to="/uet/course-class">Lớp khóa học</Link>
                            </Menu.Item>
                        </SubMenu>
                    ...
                    <Content style={{margin: '0 16px', marginTop: '64px'}}>
                        ...
                        <div className="site-layout-background" style={{padding: 24, minHeight: '100vh'}}>
                            ...
                            <Switch>
                                ...
                                <Route exact path="/uet/training-programs/clone/:uuid"
                                ...
                                <Route exact path="/uet/documents/:doc_of/:resourceUuid" component={DocumentPage}/>
                                <Route exact path="/uet/documents/:doc_of" component={DocumentPage}/>
                                <Route path="/uet/majors" component={MajorPage}/>
                                <Route path="/uet/training-types" component={TrainingProgramType}/>
                                <Route path="/uet/course-class" component={CourseClass}/>
                                <Route path="/uet/course-year" component={CourseYear}/>
