...
const SummaryContentCourse = () => {
    ...
    function getLockedOutlineContent(course) {
        ...
        if(trainingProgram.lock_edit) {
           outline = course.outline_snapshots ? course.outline_snapshots.find(outline => outline.uuid === course.training_program_course.outlineUuid) : null;
        }
        else {
                                ...
                                <>
                                    ...
                                    >
                                        ...
                                        <Descriptions.Item label="Nội dung học phần">
                                            {
                                                parser(getLockedOutlineContent(course))
                                            }
                                        </Descriptions.Item>
                                    </Descriptions>
                                    <br/><br/>
